    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <section className="pt-20 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-orange-50 dark:bg-orange-950 text-orange-700 dark:text-orange-400 text-sm font-medium px-4 py-2 rounded-full mb-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={feature.title}
                className="p-6 rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-orange-100 dark:hover:border-orange-900 hover:shadow-sm dark:bg-gray-900/50 transition-all"
              >
      ...
      <section className="py-24 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <Link href="/signup">
            <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white px-10 h-12 text-base font-semibold">
              Criar conta grátis
              <ArrowRight className="w-5 h-5 ml-2" />
            </Button>
          </Link>
